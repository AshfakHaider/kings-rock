...
export type ZeusxStatus = "pending" | "posting" | "posted" | "failed";
...
export type StockAccount = {
  ...
  notes?: string | null;
  zeusx_enabled?: boolean | null;
  zeusx_status?: ZeusxStatus | null;
  zeusx_category?: string | null;
  zeusx_game?: string | null;
  zeusx_server?: string | null;
  zeusx_delivery_method?: string | null;
  zeusx_delivery_days?: number | null;
  zeusx_delivery_hours?: number | null;
  zeusx_description?: string | null;
  zeusx_tags?: string[] | null;
  zeusx_listing_url?: string | null;
  zeusx_posted_at?: string | null;
  zeusx_error?: string | null;
